...
class MMETR(nn.Module):
    ...
    def __init__(self, model_name='vit_large_patch16_384', img_size=384, patch_size=16, in_chans=3, embed_dim=1024,
        ...
        super(MMETR, self).__init__(**kwargs)
    ...
    def forward(self, x):
        ...
        p6_se, p12_se, p18_se, p24_se = self.mla_se(c6, c12, c18, c24)
        p6_de, p12_de, p18_de, p24_de = self.mla_de(c6, c12, c18, c24)
